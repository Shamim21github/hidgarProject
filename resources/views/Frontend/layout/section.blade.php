        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image"
                    data-background="{{ asset('Frontend/assets/images/slider/slide-9.jpg') }}">
            ...
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image"
                    data-background="{{ asset('Frontend/assets/images/slider/slide-8.jpg') }}">
                    <!-- <div class="gradient-overlay"></div> -->
                    <div class="container-fluid">
                        <div class="slide-content">
                            <div data-swiper-parallax="300" class="slide-title">
            ...
            <div class="swiper-slide">
                <div class="slide-inner slide-bg-image"
                    data-background="{{ asset('Frontend/assets/images/slider/slide-10.jpg') }}">
                    <!-- <div class="gradient-overlay"></div> -->
                    <div class="container-fluid">
                        <div class="slide-content">
                            <div data-swiper-parallax="300" class="slide-title">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="service-card">
                    ...
                    <div class="content">
                        <div class="icon">
                            <img src="{{ asset('Frontend/assets/images/service/icon-1.svg') }}"
                                alt="">
                        </div>
                        <h2><a href="service-single.html">Power & Energy Sectors</a></h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="service-card">
                    ...
                    <div class="content">
                        <div class="icon">
                            <img src="{{ asset('Frontend/assets/images/service/icon-2.svg') }}"
                                alt="">
                        </div>
                        <h2><a href="service-single.html">Architectures & Design</a></h2>
                        <p>Sagittis fringilla a scelerisque sitro consetetur nunc. Urna est eget pellentesque.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="service-card">
                    ...
                    <div class="content">
                        <div class="icon">
                            <img src="{{ asset('Frontend/assets/images/service/icon-3.svg') }}"
                                alt="">
                        </div>
                        <h2><a href="service-single.html">Explore Tiling & Painiting</a></h2>
                        <p>Sagittis fringilla a scelerisque sitro consetetur nunc. Urna est eget pellentesque.
                        </p>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="testimonial-slide owl-carousel">
            <div class="testimonial-card">
                ...
                <div class="client">
                    <div class="client-img">
                        <img src="{{ asset('Frontend/assets/images/testimonial/img-2.jpg') }}"
                            alt="">
                    </div>
            ...
            <div class="testimonial-card">
                ...
                <div class="client">
                    <div class="client-img">
                        <img src="{{ asset('Frontend/assets/images/testimonial/img-3.jpg') }}"
                            alt="">
                    </div>
                    <div class="client-text">
            ...
            <div class="testimonial-card">
                ...
                <div class="client">
                    <div class="client-img">
                        <img src="{{ asset('Frontend/assets/images/testimonial/img-1.jpg') }}"
                            alt="">
                    </div>
                    <div class="client-text">
