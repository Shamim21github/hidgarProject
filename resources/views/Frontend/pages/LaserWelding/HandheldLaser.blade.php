    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mt-2 ">
                <h1 style="text-align: center;">Future of Precision Metalworking</h1>
            </div>
            <div class="col-md-12">
                <h6 style="text-align: center;">Experience unmatched welding precision and efficiency. Elevate your metalworking craftsmanship to new heights.</h6>
            </div> <br> <br> <br>
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 28rem;">
                    <a href="#">
                        <div class="card-body">
                            <h4 class="card-title" >Handheld Laser Welding Machine 
                                - Built for High-quality Welding</h4>
            ...
            <div class="col-md-12">
                <h4 class="text-center">Best Handheld Laser Welder Parameters</h4>
            </div>
            <div class="col-md-12 ">
