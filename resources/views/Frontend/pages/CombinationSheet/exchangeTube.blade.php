...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <h6 style="text-align: center;">Easily adjust to various material types and thicknesses and supports cutting of different diameters pipes, offering flexible processing options.</h6>
            </div> <br> <br> <br>
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    <a href="#">
                        <img src="{{ asset('Frontend/assets/images/1\5.jpg') }}" class="card-img-top enlargeable"
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 28rem;">
                    <a href="#">
                        <div class="card-body">
                            <h4 class="card-title" >Exchange Platform Sheet and Tube Laser Cutting Machine</h4>
                            <p class="card-text" style="text-align: left">Features: <br>  Automatic exchange platform, continuous operation is achieved and production efficiency is significantly improved. <br> It can handle both sheet and tube, saving space and money on more machines</p>
                            <div>
