    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mt-2 ">
                <h1 style="text-align: center;">Protective Enclosed Sheet and Tube Laser Cutting Machine</h1>
            </div>
            <div class="col-md-12">
                <h6 style="text-align: center;"> Using European standard protective covers is more environmentally friendly. Handle both sheet and tube, saving space and money on more machines.</h6>
            </div> <br> <br> <br>
            <div class="col-md-6 mb-4">
                <div class="card position-relative" style="width: 100%; text-align: center;">
                    <a href="#" onclick="openModal('{{ asset('Frontend/assets/images/enclosed/1.jpg') }}')">
                        <img src="{{ asset('Frontend/assets/images/enclosed/1.jpg') }}"
            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body"> <br> <br>
                        <h4 class="card-title text-center">Enclosed Sheet and Tube Laser Cutting Machine</h4> <br>
                        <p class="card-subtitle mb-2 text-muted">Features:Using European standard protective covers is more environmentally friendly.Its advanced controls are user-friendly, making it easy to learn and maintain
    ...
    <div class="container my-2">
        <div class="card shadow-lg border-0">
            <div class="row no-gutters">
                ...
                <div class="col-md-4">
                    <img src="{{ asset('Frontend/assets/images/enclosed/enclosed6.png') }}"
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <p class="card-text mt-5" style="text-align: justify;">
                            <br> 
                            <li>European Standard Protective Covers: Environmentally friendly design.</li>
                            <li>Efficient Smoke and Dust Filtration: Internally filters cutting smoke and dust, ensuring pollution-free discharge.</li>
                            <li>Laser Protective Screen: Installed on the protective cover for safer observation of the processing situation.</li>
                            <br>
                            <br>
                        </p>
                    </div>
