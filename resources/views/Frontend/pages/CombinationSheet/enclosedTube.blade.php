...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <h6 style="text-align: center;">Using European standard protective covers is more environmentally friendly. The smoke and dust generated by cutting are directly filtered internally. A visible laser protective screen is installed on the protective cover.</h6>
            </div> <br> <br> <br>
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 28rem;">
                    <a href="#">
                        <div class="card-body">
                            <h4 class="card-title" >Protective Enclosed Sheet and Tube Laser Cutting Machine</h4>
                            ...
                            <div>
                                <ul class="text-dark" style="text-align: left">
                                    ...
                                    <li>The laser protective screen installed on the protective cover allows for safer observation of the processing situation.</li>
                                </ul>
                            </div> <br>
            ...
            <div class="col-md-12">
                <h4 class="text-center">TECHNICAL PARAMETERS</h4>
            </div>
            <div class="col-md-12 ">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">LF-ST</th>
                            <th scope="col">LF-STE</th>
                            <th scope="col">LF-STP</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">Laser output power</th>
                        ...
                        <tr>
                            <th scope="row">Repositioning accuracy</th>
                            <td>0.03mm</td>
                            <td>0.03mm</td>
                            <td>0.03mm</td>  
                        </tr>
                        <tr>
                            <th scope="row">Round tube cutting diameter</th>
                            <td>20mm~230mm</td>
                            <td>20mm~230mm</td>
                            <td>20mm~230mm</td>  
                        </tr>
                        <tr>
                            <th scope="row">Square tube cutting diameter</th>
                            <td>20mm~140mm</td>
                            <td>20mm~140mm</td>
                            <td>20mm~140mm</td>  
                        </tr>
                        <tr>
                            ...
                            <td>Air Conditioner, Smoke Purifier, Air Compressor,Voltage Regulator, Safety Light Curtain</td>  
                        </tr>
