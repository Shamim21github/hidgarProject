...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mt-2 ">
                <h1 style="text-align: center;"> Three Chuck Tube Fiber Laser Cutting machine</h1>
            </div>
            <div class="col-md-12">
                <h6 style="text-align: center;">Fast speed,high precision, high cost performance</h6>
            </div> <br> <br> <br>
            <div class="col-md-6 mb-4">
                <div class="card position-relative" style="width: 100%; text-align: center;">
                    <a href="#" onclick="openModal('{{ asset('Frontend/assets/images/3Chuck/1.jpg') }}')">
                        <img src="{{ asset('Frontend/assets/images/3Chuck/1.jpg') }}" class="card-img-top enlargeable"
    ...
    {{-- <div class="col-md-12">
        <h3>Efficient Cutting, No Deformation</h3>
        ...
        <img src=" {{ asset('Frontend/assets/images/3Chuck/Chunk1') }}" alt="">
    ...
    <h4 class="card-title text-center">
        Efficient Cutting, No Deformation</h4>
    <div class="container my-4">
        <div class="card shadow-lg border-0">
            <div class="row no-gutters">
                <!-- Left Column with Image -->
                <div class="col-md-4">
                    <img src="{{ asset('Frontend/assets/images/3Chuck/Chuck1.png') }}" alt="CNC Laser Pipe Cutting"
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <p class="card-text mt-5" style="text-align: justify;">
                            The unique structural design adopts segmented automatic support device to solve the deformation
                            problem caused by long pipe cutting.
                            It is stable and vibration-resistant. It improves working accuracy and prolongs the service life
                            of the chuck and transmission structure.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <h4 class="card-title text-center">
        Three-Chuck Clamping, Stable Cutting</h4>
    <div class="container my-4">
        <div class="card shadow-lg border-0">
            <div class="row no-gutters">
                <!-- Left Column with Image -->
                <div class="col-md-4">
                    <img src="{{ asset('Frontend/assets/images/3Chuck/Chuck2.png') }}" alt="CNC Laser Pipe Cutting"
                        class="img-fluid rounded-left" style="height: 100%; width:100%;">
                </div>
                <!-- Right Column with Text -->
                <div class="col-md-8">
                    <div class="card-body">
                        <p class="card-text mt-5" style="text-align: justify;">
                            One-button clamping, automatic centering, high degree of automation.
                            Three times faster than electric chuck, saving waiting time.
                            Equipped with clamping claws, saving materials.
                            The clamping strength can be adjusted conveniently and quickly according to the thickness of the
                            pipe wall.
                        </p>
                    </div>
                </div>
    ...
    <h4 class="card-title text-center">
        Intelligent Contour Recognition</h4>
    <div class="container my-4">
        <div class="card shadow-lg border-0">
            <div class="row no-gutters">
                <!-- Left Column with Image -->
                <div class="col-md-4">
                    <img src="{{ asset('Frontend/assets/images/mini/mini1.png') }}" alt="CNC Laser Pipe Cutting"
                        class="img-fluid rounded-left" style="height: 100%; width:100%;">
                </div>
                <!-- Right Column with Text -->
                <div class="col-md-8">
                    <div class="card-body">
                        <p class="card-text" style="text-align: justify;">
                            With contour recognition system, it can automatically identify standard round, oval, square and
                            other special-shaped pipes. <br>

                            Tubes realize non-inductive and high-efficiency detection, and realize the position deviation of
                            the whole meter section’s cutting accuracy within 0.15mm.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container my-4">
        <div class="card shadow-lg border-0">
            <div class="row no-gutters">
                <!-- Left Column with Image -->
                <div class="col-md-4">
                    <img src="{{ asset('Frontend/assets/images/3Chuck/Chuck3.png') }}" alt="CNC Laser Pipe Cutting"
                        class="img-fluid rounded-left" style="height: 100%; width:100%;">
                </div>
                <!-- Right Column with Text -->
                <div class="col-md-8">
                    <div class="card-body">
                        <p class="card-text" style="text-align: justify;">
                            Square tube welding bed. The internal structure adopts aircraft metal honeycomb structure. The
                            bed has high strength and tensile resistance, and the guide surface is more stable.
                            High temperature annealing treatment eliminates the stress generated by welding machine
                            processing. Reduce the loss of laser cutting machine during use, and it will not deform after 30
                            years of use.
                        </p>
                    </div>
                </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2"> 1500w, 2000w, 3000w, Higher Power</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="4">Alr Conditioner,Smoke Puriher,Air Compressor,Voltage Reglator,Satety Lignt Curtain
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 position-relative text-center mb-3">
                <img src="{{ asset('Frontend/assets/images/mini/mini3.png') }}" alt="Sheet Metal"
                    class="card-img-top w-100">
                <h4 class="overlay-text">High-Precision 3D Laser Cutting Head</h4>
            </div>
            <div class="col-md-4 position-relative text-center">
                <img src="{{ asset('Frontend/assets/images/mini/mini4.png') }}" alt="Sheet Metal"
                    class="card-img-top w-100">
                <h4 class="overlay-text">Advanced Pneumatic Chuck</h4>
            </div>
            <div class="col-md-4 position-relative text-center">
                <img src="{{ asset('Frontend/assets/images/mini/mini5.png') }}" alt="Sheet Metal"
                    class="card-img-top w-100" style="height: 330px">
            ...
            <div class="col-md-4 position-relative text-center">
                <img src="{{ asset('Frontend/assets/images/mini/mini8.png') }}" alt="Sheet Metal"
                    class="card-img-top w-100">
