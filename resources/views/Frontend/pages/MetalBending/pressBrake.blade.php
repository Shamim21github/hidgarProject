    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mt-2 ">
                <h1 style="text-align: center;">Press Brake Smart</h1>
            </div>
            <div class="col-md-12">
                <h6 style="text-align: center;">Press brake are designed with precision engineering and robust construction, ensuring powerful and reliable performance.</h6>
            </div> <br> <br> <br>
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 28rem;">
                    <a href="#">
                        <div class="card-body">
                            <h4 class="card-title" >Press Brake Smart</h4>
                            <p class="card-text" style="text-align: left">Features: <br>  Our Press Brake Smart have a cutting-edge design, delivers clean and uniform laser welding outcomes. It cuts maintenance costs and enhances work speed.</p>
            ...
            <div class="col-md-12">
                <h4 class="text-center">Press Brake Smart Parameters</h4>
            </div>
            <div class="col-md-12 ">
