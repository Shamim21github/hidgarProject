    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mt-2 ">
                <h1 style="text-align: center;">Pipe Bending Machine</h1>
            </div>
            <div class="col-md-12">
                <h6 style="text-align: center;">Pipe Bending are designed with precision engineering and robust construction, ensuring powerful and reliable performance.</h6>
            </div> <br> <br> <br>
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    <a href="#">
                        <img src="{{ asset('Frontend/assets/images/2\2.15.jpg') }}" class="card-img-top enlargeable"
                ...
                <div class="card" style="width: 28rem;">
                    <a href="#">
                        <div class="card-body">
                            ...
                            <p class="card-text" style="text-align: left">Features: <br>  Our Pipe Bending Machine have a cutting-edge design, delivers clean and uniform laser welding outcomes. It cuts maintenance costs and enhances work speed.</p>
            ...
            <div class="col-md-12">
                <h4 class="text-center">Pipe Bending Machine  Parameters</h4>
            </div>
            <div class="col-md-12 ">
